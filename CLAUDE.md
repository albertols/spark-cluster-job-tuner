...
- **Deep algorithm details** (boost lifecycle, b16 compound carry, z-score scale-up, trend scaling v2, capacity guard): see `.claude/skills/cluster-tuning/SKILL.md` (auto-loads when editing the module).
- **Frontend contracts** (`boost_groups`, divergences table sorting, dashboard v2 surfaces): see `.claude/skills/frontend/SKILL.md`.
- **OssMockMain `--full` chain**: see `.claude/skills/oss-mock-data/SKILL.md`.
