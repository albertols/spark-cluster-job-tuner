...
WITH app_base AS (
  ...
  --\{"event_type":"application_end","event_type_family":"SCALAMATICA-DWH_TO_CDM","clusterName":"cluster-wf-dpr-load-t-04-35-0435","recipeFilename":"_ETL_m_DM_LKP_CUOTA_INDICE_FX.json","layerToLayer":"DWH_TO_CDM","version":"0.6.6","app_start_iso":"2026-03-30T08:12:22.644Z","app_end_iso":"2026-03-30T09:27:07.238Z","app_duration_millis":"4484594"\}
  SELECT
    COALESCE(
...
status_base AS (
  ...
  --"Execution status: {"CLUSTER_NAME":"cluster-wf-dpr-load-t-04-35-0435","LAYER":"DWH_TO_CDM","BUSINESS_DATE":"2026-03-29","JOB_ID":"application_1774841886808_0243","RECIPE":"_ETL_m_DM_LKP_CUOTA_INDICE_FX.json","NAR_ID":"","SOURCE_TABLES":"DWH_LKP_CUOTA_INDICE_FX","STATUS":"SUCCESS","MESSAGE":"","COUNT":3829507179,"CONTROL_ERRORS_COUNT":0,"START_TIME":"2026-03-30T08:12:20.000Z","END_TIME":"2026-03-30T09:27:00.000Z","DURATION":"1h 14m 40sec","ARGUMENTS":"--executionMode=GCP --env=prd --sourceIO=BQ --targetIO=BQ --projectVersion=0.6.6 --layer=DWH_TO_CDM --parallelizationFactor=5
  --recipeFilename=_ETL_m_DM_LKP_CUOTA_INDICE_FX.json --clusterName=cluster-wf-dpr-load-t-04-35-0435 --partitionDateFormat=yyyy-MM-dd --businessDate=2026-03-29 --scheduleTime=2026-03-29T19:30:00+00:00","SCHEDULE_TIME":"2026-03-29T19:30:00.000Z","TARGET_TABLE":"LKP_CUOTA_INDICE_FX"}"
  SELECT
